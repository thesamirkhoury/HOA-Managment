          ...
          <td>
            ...
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <h1 data-id="react-email-heading" style="color:rgb(0,0,0);text-align:center;font-weight:400;font-size:24px">דרישת תשלום חדשה</h1>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">,שלום ${tenant.firstName}</p>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">.התקבלה דרישת תשלום חדשה עבורך על סך ${amount} ש״ח<br />.לפרטים נוספים יש להכנס למערכת הדיירים</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="text-align:center">
              <tbody>
                <tr>
                  <td><a href="${process.env.TENANTS_URL}/billings" data-id="react-email-button" target="_blank" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;padding:12px 20px;background-color:rgb(0,0,0);border-radius:0.25rem;color:rgb(255,255,255);font-size:12px;font-weight:600;text-decoration-line:none;text-align:center"><span></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">כניסה למערכת</span><span></span></a></td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
...
<html lang="he" dir="rtl">
  ...
  <head data-id="__react-email-head"></head>
  <div id="__react-email-preview" style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">תזכורת לתשלום דרישת תשלום
  </div>
          ...
          <td>
            ...
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <h1 data-id="react-email-heading" style="color:rgb(0,0,0);text-align:center;font-weight:400;font-size:24px">תזכורת לתשלום דרישת תשלום</h1>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">,שלום ${tenant.firstName}</p>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">.זאת תזכורת לשלם דרישת תשלום שהופקה על ידי הועד שלך על סך ${amount} ש״ח<br />.לפרטים נוספים יש להכנס למערכת הדיירים</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="text-align:center">
              <tbody>
                <tr>
                  <td><a href="${process.env.TENANTS_URL}/billing" data-id="react-email-button" target="_blank" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;padding:12px 20px;background-color:rgb(0,0,0);border-radius:0.25rem;color:rgb(255,255,255);font-size:12px;font-weight:600;text-decoration-line:none;text-align:center"><span></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">כניסה למערכת</span><span></span></a></td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
...
<html lang="he" dir="rtl">
  ...
  <head data-id="__react-email-head"></head>
  <div id="__react-email-preview" style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">קישור לאיפוס הסיסמה
  </div>
          ...
          <td>
            ...
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <h1 data-id="react-email-heading" style="color:rgb(0,0,0);text-align:center;font-weight:400;font-size:24px">?שחכת את הסיסה שלך</h1>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">,שלום ${firstName}</p>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">.קיבלנו בקשה לאיפוס הסיסמה שלך<br/>.מצורף קישור לבחירת סיסמה חדשה</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="text-align:center">
              <tbody>
                <tr>
                  <td><a href="${url}" data-id="react-email-button" target="_blank" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;padding:12px 20px;background-color:rgb(0,0,0);border-radius:0.25rem;color:rgb(255,255,255);font-size:12px;font-weight:600;text-decoration-line:none;text-align:center"><span></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">איפוס סיסמה</span><span></span></a>
                    <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">או בקישור הבא:<br /><a href="${url}" data-id="react-email-link" target="_blank" style="color:rgb(37,99,235);text-decoration:none;text-decoration-line:none;text-align:center">${url}</a></p>
                    <p data-id="react-email-text" style="font-size:12px;line-height:24px;margin:16px 0;text-align:center">.הקישור תקף ל-10 דקות בלבד<br />.אם לא ביקשת להחליף את הסיסמה ניתן להתעלם מהייל הזה</p>
                  </td>
                </tr>
              </tbody>
            </table>
...
async function sendUsername(recipient, firstName, username) {
  let subject = "שם המשתמש שלך";
  let html = `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<html lang="he" dir="rtl">
  ...
  <head data-id="__react-email-head"></head>
  <div id="__react-email-preview" style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">תזכורת לשם המשתמש
  </div>
          ...
          <td>
            ...
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <h1 data-id="react-email-heading" style="color:rgb(0,0,0);text-align:center;font-weight:400;font-size:24px">שם המשתמש שלך למערכת הדיירים</h1>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">,שלום ${firstName}</p>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">הועד שלך שלח לך את שם המשתש למערכת ניהול ועד הבית כתזכורת, החשבון שלך כבר קיים במערכת.</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="text-align:center;margin-top:10px;margin-bottom:32px">
              <tbody>
                <tr>
                  <td>
                    <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">שם המשתמש שלך:<br /><strong>${username}</strong></p><a href="${process.env.TENANTS_URL}" data-id="react-email-button" target="_blank" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;padding:12px 20px;background-color:rgb(0,0,0);border-radius:0.25rem;color:rgb(255,255,255);font-size:12px;font-weight:600;text-decoration-line:none;text-align:center"><span></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">כניסה למערכת</span><span></span></a>
                  </td>
                </tr>
              </tbody>
            </table>
...
<html lang="he" dir="rtl">
  ...
  <head data-id="__react-email-head"></head>
  <div id="__react-email-preview" style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">אישור סגירת חשבון
  </div>
          ...
          <td>
            ...
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <h1 data-id="react-email-heading" style="color:rgb(0,0,0);text-align:center;font-weight:400;font-size:24px">אישור על סגירת חשבון הועד</h1>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">,שלום ${firstName}</p>
                    <p data-id="react-email-text" style="font-size:18px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">.המייל הזה מאשר את סגירת החשבון שלך<br />
                    .כל המידע השמור ימיחק במהלך הדקות הקרובות, כולל כל ההוצאות וההכנסות<br />.גישתך וגית כל הדיירים של הועד שלך תחסם במהלך הדקות הקרובות</p>
                    <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0);text-align:center">הפעולה הינה סופית והמידע לא ניתן לשיחזור.<br />זה הינו אישור סופי, הודעה נוספת לא תשלח.</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(102,102,102);text-align:center">ההודעה הזאת נשלחה באופן אוטומאטי<br />כל מהשצוין לעיל הינו בהתאם<a href="${process.env.TERMS_URL}" data-id="react-email-link" target="_blank" style="color:rgb(37,99,235);text-decoration:none;text-decoration-line:none">לתנאי השימוש</a><br /></p>
                  </td>
                </tr>
              </tbody>
            </table>
