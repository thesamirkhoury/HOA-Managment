                ...
                <tr>
                  <td>
                    ...
                    <p
                      ...
                      "
                    >
                      הועד שלך הוסיף אותך למערכת ניהול ועד הבית, להלן פרטי
                      החשבון שלך.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <p
                      ...
                      "
                    >
                      שם המשתמש שלך:<strong>${username}</strong>
                    </p>
                    <a
                    ...
                    <p
                      ...
                      "
                    >
                      או ללחוץ/להעתיק את הקישור הבא:<a
                      href="${process.env.TENANTS_URL}/set-password/${token}"
                        ...
                        "
                        >
                        ${process.env.TENANTS_URL}/set-password/${token}</a
                      >
                    </p>
                    <p
                      data-id="react-email-text"
                ...
                <tr>
                  <td>
                    <p
                      ...
                      "
                    >
                      בעת השלמת ההרשמה למערכת, אתה מסקים<a
                ...
                <tr>
                  <td>
                    ...
                    <p
                      ...
                      "
                    >
                      התעדכן הסטטוס לקריאת השירות שפתחת בנושה ${requestSubject}
                      <br />
